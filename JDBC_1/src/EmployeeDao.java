...
public class EmployeeDao {
    ...
    public List<Employee> readAll() throws SQLException{
        ...
        ResultSet result = statement.executeQuery(); //ResultSet keeps info regarding the DB (rows and columns data);
    ...
    //update
    public void update(int id, String surname) throws SQLException{
        Connection connection = getConnection();
